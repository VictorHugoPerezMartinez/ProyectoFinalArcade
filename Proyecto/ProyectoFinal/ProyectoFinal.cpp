...
int main()
{
	...
	Model Maquinita((char*)"Models/Maq/AsterFireArcade.obj");
	Model Maquinita2((char*)"Models/a/HoopsArcade.obj");
	Model Maquinita3((char*)"Models/c/untitled.obj");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		model = glm::scale(model, glm::vec3(0.1f, 0.1f, 0.1f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		Maquinita2.Draw(lightingShader);

		model = glm::translate(model, glm::vec3(500.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(50.0f, 50.0f, 50.0f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		Maquinita3.Draw(lightingShader);
